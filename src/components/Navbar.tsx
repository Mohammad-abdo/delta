                ...
                <div className="absolute top-full right-0 mt-0 w-56 bg-white rounded-lg shadow-lg border border-muted py-2 z-50">
                  {homeDropdownItems.map((item) => (
                    <button
                      ...
                      className="block w-full text-right px-4 py-2 text-sm font-medium transition-fast hover:text-primary hover:bg-muted"
                    >
                      {item.label}
                    </button>
                  ))}
                  ...
                  <div className="mt-1 pr-4 space-y-0.5">
                    {homeDropdownItems.map((item) => (
                      <button
                        key={item.section}
                        onClick={() => scrollToSection(item.section)}
                        className="block w-full text-right px-4 py-2 text-sm font-medium rounded-lg transition-fast hover:text-primary hover:bg-muted"
                      >
                        {item.label}
                      </button>
                    ))}
